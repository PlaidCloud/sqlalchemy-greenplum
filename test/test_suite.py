...
#     __prefer__ = 'greenplum'

#     def test_format(self):
#         seq = Sequence('my_seq_no_schema')
#         dialect = greenplum.dialect()
...
class CompileTest(fixtures.TestBase, AssertsCompiledSQL):
    ...
    #     typ = greenplum.ENUM(
    #         "val1", "val2", "val's 3", u('meil'), name="myname")
    #     self.assert_compile(
    #         greenplum.CreateEnumType(typ),
    #         u("CREATE TYPE myname AS "
    #             "ENUM ('val1', 'val2', 'val''s 3', 'méil')"))

    #     typ = greenplum.ENUM(
    #         "val1", "val2", "val's 3", name="PleaseQuoteMe")
    #     self.assert_compile(greenplum.CreateEnumType(typ),
    ...
    #     self.assert_compile(greenplum.CreateEnumType(e1),
    #                         "CREATE TYPE somename AS ENUM ('x', 'y', 'z')"
    #                         )
    #     self.assert_compile(greenplum.CreateEnumType(e2),
    #                         "CREATE TYPE someschema.somename AS ENUM "
    #                         "('x', 'y', 'z')")
    #     self.assert_compile(greenplum.DropEnumType(e1),
    #                         'DROP TYPE somename')
    #     self.assert_compile(greenplum.DropEnumType(e2),
    ...
    #     self.assert_compile(
    #         greenplum.CreateEnumType(e1),
    #         "CREATE TYPE foo.somename AS ENUM ('x', 'y', 'z')",
    #         schema_translate_map=schema_translate_map
    #     )

    #     self.assert_compile(
    #         greenplum.CreateEnumType(e2),
    ...
    def test_create_table_inherits_quoting(self):
        ...
        tbl = Table(
            'atable', m, Column("id", Integer),
            greenplum_inherits=('Quote Me', 'quote Me Too'))
        self.assert_compile(
            schema.CreateTable(tbl),
    ...
    def test_create_table_partition_by_list(self):
        ...
        tbl = Table(
            ...
            greenplum_partition_by='LIST (part_column)')
        self.assert_compile(
            schema.CreateTable(tbl),
    ...
    def test_create_table_partition_by_range(self):
        ...
        tbl = Table(
            'atable', m, Column("id", Integer), Column("part_column", Integer),
            greenplum_partition_by='RANGE (part_column)')
        self.assert_compile(
            schema.CreateTable(tbl),
            'CREATE TABLE atable (id INTEGER, part_column INTEGER) '
    ...
    def test_create_partial_index(self):
        ...
        idx = Index('test_idx1', tbl.c.data,
                    greenplum_where=and_(tbl.c.data > 5, tbl.c.data
                                          < 10))
        idx = Index('test_idx1', tbl.c.data,
                    greenplum_where=and_(tbl.c.data > 5, tbl.c.data
                                          < 10))
        ...
        idx2 = Index('test_idx2', tbl.c.data,
                     greenplum_where=and_(tbl.c.data > 'a', tbl.c.data
                                           < "b's"))
    ...
    def test_create_index_with_ops(self):
        ...
        idx = Index('test_idx1', tbl.c.data,
                    greenplum_ops={'data': 'text_pattern_ops'})
    ...
    def test_create_index_with_labeled_ops(self):
        ...
        idx = Index('test_idx1', func.lower(tbl.c.data).label('data_lower'),
                    greenplum_ops={'data_lower': 'text_pattern_ops'})

        idx2 = Index(
            'test_idx2',
            (func.xyz(tbl.c.data) + tbl.c.d2).label('bar'),
            tbl.c.d2.label('foo'),
            greenplum_ops={'bar': 'text_pattern_ops',
                            'foo': 'int4_ops'})
    ...
    def test_create_index_with_using(self):
        ...
        idx2 = Index('test_idx2', tbl.c.data, greenplum_using='btree')
        idx3 = Index('test_idx3', tbl.c.data, greenplum_using='hash')
    ...
    def test_create_index_with_with(self):
        ...
        idx1 = Index('test_idx1', tbl.c.data)
        idx2 = Index(
            'test_idx2', tbl.c.data, greenplum_with={"fillfactor": 50})
        idx3 = Index('test_idx3', tbl.c.data, greenplum_using="gist",
                     greenplum_with={"buffering": "off"})
    ...
    def test_create_index_with_tablespace(self):
        ...
        idx3 = Index('test_idx3',
                     tbl.c.data,
                     greenplum_tablespace='another table space')
    ...
    def test_create_index_with_multiple_options(self):
        ...
        idx1 = Index('test_idx1',
                     tbl.c.data,
                     greenplum_using='btree',
                     greenplum_tablespace='atablespace',
                     greenplum_with={"fillfactor": 60},
                     greenplum_where=and_(tbl.c.data > 5, tbl.c.data < 10))
    ...
    #     idx1 = Index('test_idx1', tbl.c.data, greenplum_concurrently=True)
    #     self.assert_compile(
    #         schema.CreateIndex(idx1),
    #         "CREATE INDEX CONCURRENTLY test_idx1 ON testtbl (data)"
    #     )

    #     # dialect_8_1 = greenplum.dialect()
    ...
    def test_from_only(self):
        ...
        stmt = talias1.select().with_hint(talias1, 'ONLY')
        ...
        # assert_raises(
        #     exc.CompileError,
        #     tbl3.select().with_hint(tbl3, "FAKE").compile
        # )
...
class InsertOnConflictTest(fixtures.TestBase, AssertsCompiledSQL):
    ...
    def setup(self):
        ...
        self.goofy_index = Index(
            ...
            greenplum_where=table1.c.name > 'm'
        )
    ...
    #         greenplum_where=self.table1.c.name > 'm'
    #     )
...
class FullTextSearchTest(fixtures.TestBase, AssertsCompiledSQL):
    ...
    def _raise_query(self, q):
        """
            ...
            self._raise_query(q)
        """
        c = q.compile(dialect=greenplum.dialect())
        raise ValueError(c)
